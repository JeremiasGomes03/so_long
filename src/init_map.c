...
/*   Updated: 2024/12/17 18:52:54 by jeremias         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	load_textures(t_game *game)
{
	...
	i = 0;
	game->textures[0] = mlx_load_png("./assets/fundo.png");
	game->textures[1] = mlx_load_png("./assets/barreira_f.png");
	game->textures[2] = mlx_load_png("./assets/urso_f.png");
	game->textures[3] = mlx_load_png("./assets/lata.png");
	game->textures[4] = mlx_load_png("./assets/lata_f.png");
